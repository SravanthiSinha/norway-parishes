import{E as g}from"./BufferObject--p5FGAc0.js";import{r as c}from"./Program-DoFM1Qk1.js";import{x as j,s as F}from"./Program-DoFM1Qk1.js";import"./index-CRM8otC0.js";import{t as p}from"./NestedMap-GuqgquCN.js";import{e as O,a as P}from"./ProgramTemplate-eorszMQW.js";import{m as A}from"./Texture-ByNBwYCf.js";import{o as q}from"./VertexArrayObject-CcBcd6Vp.js";import"./enums-Dk3osxpS.js";class d{constructor(e){this._rctx=e,this._store=new p}dispose(){this._store.forAll(e=>e.dispose()),this._store.clear()}acquire(e,t,o,n){const r=this._store.get(e,t);if(r!=null)return r.ref(),r;const s=new c(this._rctx,e,t,o,n);return s.ref(),this._store.set(e,t,s),s}get test(){}}function m(i){const{options:e,value:t}=i;return typeof e[t]=="number"}function b(i){let e="";for(const t in i){const o=i[t];if(typeof o=="boolean")o&&(e+=`#define ${t}
...
//# sourceMappingURL=webglDeps-B3JDtztF.js.map
