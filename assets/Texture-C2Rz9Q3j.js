const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RealisticTree.glsl-IEgbFWOL.js","assets/index-j6yFHuRy.js","assets/index-Jib82o7I.css","assets/QueryEngine-Cx0mXE3I.js","assets/featureConversionUtils-CWlweu21.js","assets/WhereClause-CwGpVo3_.js","assets/TimeOnly-Bvt5N_mb.js","assets/timeSupport-D6H49xfb.js","assets/QueryEngineCapabilities-DjYb9CEb.js","assets/Scheduler-D8Qfp1e9.js","assets/signal-C6JO_0DC.js","assets/ReactiveMap-0PxNCZ9S.js","assets/PooledRBush-BzcDYq3E.js","assets/quickselect-QQC62dOK.js","assets/ViewingMode-dBUh39ak.js","assets/Indices-ColLY48e.js","assets/glUtil-CFv2RXTA.js","assets/enums-Dk3osxpS.js","assets/VertexElementDescriptor-BOD-G50G.js","assets/NormalAttribute.glsl-C3M9rTRp.js","assets/interfaces-DDtDqZYj.js","assets/VertexAttribute-BdZWZuT1.js","assets/basicInterfaces-CZwQPxTp.js","assets/NestedMap-GuqgquCN.js","assets/mat4f64-CSKppSlJ.js","assets/Util-BxOTaDfH.js","assets/vec32-CLDLXykA.js","assets/InterleavedLayout-CqhIJ2V8.js","assets/BufferView-BFN8Wr28.js","assets/types-D0PSWh4d.js","assets/Octree-k12zQ0CE.js","assets/sphere-B8YNY3VQ.js","assets/mat3-DSYHFVyP.js","assets/mat3f64-q3fE-ZOt.js","assets/plane-D_hNRzaa.js","assets/quatf64-aQ5IuZRd.js","assets/IntersectorInterfaces-dI_rFEZm.js","assets/BufferObject-o98FkG4G.js","assets/Texture-Ck7lu_n2.js","assets/boundedPlane-DEu4HMNq.js","assets/lineSegment-CET45eNS.js","assets/VertexArrayObject-BLE5D7wv.js","assets/doublePrecisionUtils-B0owpBza.js","assets/floatRGBA-DoWV_JFi.js","assets/AlphaCutoff-UcccL64p.js","assets/renderState-BqKKaxGi.js","assets/projectVectorToVector-lszDgCRc.js","assets/projectPointToVector-DSYsMTW6.js","assets/computeTranslationToOriginAndRotation-4nTPOwOX.js","assets/MeshLocalVertexSpace-CXSikqtm.js","assets/vec3f32-nZdmKIgz.js","assets/orientedBoundingBox-Djcx1UQ5.js","assets/quat-Com0Jwzo.js","assets/spatialReferenceEllipsoidUtils-DvkhqtJM.js","assets/triangle-BIk4q5o4.js","assets/BindType-BmZEZMMh.js"])))=>i.map(i=>d[i]);
import{aN as N,bE as si,I as Te,s as li,cc as ci,d2 as Rt,j as m,m as z,k as ur,an as di,ao as ui,dx as go,lH as xo,aR as hr,hk as Je,k0 as Qt,bH as oe,ho as Dt,T as To,i8 as ye,az as _o,hi as bo,bR as It,nM as hi,nN as mi,gn as Le,gp as Ft,hh as zt,bT as fi,bS as Eo,cA as So,cO as Co,hq as ut,c4 as Ao,nO as wo,nP as Mo,jq as yo,_ as Tt,du as St,hs as Oo,fp as Ro,b5 as Io,eP as Ir,jf as No,cz as rt,g5 as it,w as Nr,nQ as $o,av as Lo,ay as Po,au as Do}from"./index-j6yFHuRy.js";import{r as ve,o as X,q as Ge,E as ht,u as Fo,c as nt,I as $r,v as zo,H as pi,R as ke,s as Ot,_ as vi,A as mr,g as Lr,P as Bo,N as Go}from"./vec32-CLDLXykA.js";import{s as U}from"./Util-BxOTaDfH.js";import{l as er}from"./ViewingMode-dBUh39ak.js";import{H as Vo}from"./InterleavedLayout-CqhIJ2V8.js";import{n as D,S as gi,u as mt,b as fe,a as Q,t as Bt,c as Pr,o as kt,r as Ho}from"./NormalAttribute.glsl-C3M9rTRp.js";import{t as Qe,o as s,r as R}from"./interfaces-DDtDqZYj.js";import{e as p}from"./VertexAttribute-BdZWZuT1.js";import{a as I}from"./BindType-BmZEZMMh.js";import{a as tr,O as rr,s as be,i as ge,e as _t,n as Gt,u as Ve}from"./basicInterfaces-CZwQPxTp.js";import{o as _e}from"./AlphaCutoff-UcccL64p.js";import"./boundedPlane-DEu4HMNq.js";import{E as xi,U as xe}from"./sphere-B8YNY3VQ.js";import{E as Uo,R as Ct,O as de,X as Oe,I as ae,D as ft,G as Ie,t as jo,_ as Wo,f as qo,c as pe,L as Ze}from"./enums-Dk3osxpS.js";import{B as Vt,o as ko,g as Ht,r as Yo,c as Xo,p as Zo,f as Ko}from"./renderState-BqKKaxGi.js";import{j as Jo}from"./mat3-DSYHFVyP.js";import{e as bt,o as et}from"./mat3f64-q3fE-ZOt.js";import{e as fr,o as Dr}from"./mat4f64-CSKppSlJ.js";import{I as Qo,L as ea}from"./orientedBoundingBox-Djcx1UQ5.js";import{x as Ti,c as Fr,y as ta,u as ra,q as ia,i as zr}from"./BufferView-BFN8Wr28.js";import{b as oa,p as _i,m as Ye,a as aa}from"./Texture-Ck7lu_n2.js";import{o as na,r as sa}from"./doublePrecisionUtils-B0owpBza.js";import{t as la}from"./requestImageUtils-BpDuZQ9K.js";let ca=class{constructor(e=0){this.componentLocalOriginLength=0,this._totalOffset=0,this._offset=0,this._tmpVertex=N(),this._tmpMbs=xi(),this._tmpObb=new Qo,this._resetOffset(e)}_resetOffset(e){this._offset=e,this._totalOffset=e}set offset(e){this._resetOffset(e)}get offset(){return this._offset}set componentOffset(e){this._totalOffset=this._offset+e}set localOrigin(e){this.componentLocalOriginLength=ve(e)}applyToVertex(e,r,i){const o=X(bi,e,r,i),a=X(ha,e,r,i+this.componentLocalOriginLength),n=this._totalOffset/ve(a);return Ge(this._tmpVertex,o,a,n),this._tmpVertex}applyToAabb(e){const r=this.componentLocalOriginLength,i=e[0],o=e[1],a=e[2]+r,n=e[3],l=e[4],c=e[5]+r,u=Math.abs(i),d=Math.abs(o),h=Math.abs(a),v=Math.abs(n),f=Math.abs(l),T=Math.abs(c),_=.5*(1+Math.sign(i*n))*Math.min(u,v),g=.5*(1+Math.sign(o*l))*Math.min(d,f),G=.5*(1+Math.sign(a*c))*Math.min(h,T),P=Math.max(u,v),F=Math.max(d,f),L=Math.max(h,T),B=Math.sqrt(_*_+g*g+G*G),M=Math.sign(u+i),S=Math.sign(d+o),E=Math.sign(h+a),y=Math.sign(v+n),O=Math.sign(f+l),x=Math.sign(T+c),C=this._totalOffset;if(B<C)return e[0]-=(1-M)*C,e[1]-=(1-S)*C,e[2]-=(1-E)*C,e[3]+=y*C,e[4]+=O*C,e[5]+=x*C,e;const w=C/Math.sqrt(P*P+F*F+L*L),V=C/B,j=V-w,q=-j;return e[0]+=i*(M*q+V),e[1]+=o*(S*q+V),e[2]+=a*(E*q+V),e[3]+=n*(y*j+w),e[4]+=l*(O*j+w),e[5]+=c*(x*j+w),e}applyToMbs(e){const r=ve(xe(e)),i=this._totalOffset/r;return Ge(xe(this._tmpMbs),xe(e),xe(e),i),this._tmpMbs[3]=e[3]+e[3]*this._totalOffset/r,this._tmpMbs}applyToObb(e){return ea(e,this._totalOffset,this._totalOffset,er.Global,this._tmpObb),this._tmpObb}},da=class{constructor(e=0){this.offset=e,this.sphere=xi(),this.tmpVertex=N()}applyToVertex(e,r,i){const o=this.objectTransform.transform,a=X(bi,e,r,i),n=ht(a,a,o),l=this.offset/ve(n);Ge(n,n,n,l);const c=this.objectTransform.inverse;return ht(this.tmpVertex,n,c),this.tmpVertex}applyToMinMax(e,r){const i=this.offset/ve(e);Ge(e,e,e,i);const o=this.offset/ve(r);Ge(r,r,r,o)}applyToAabb(e){const r=this.offset/Math.sqrt(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]+=e[0]*r,e[1]+=e[1]*r,e[2]+=e[2]*r;const i=this.offset/Math.sqrt(e[3]*e[3]+e[4]*e[4]+e[5]*e[5]);return e[3]+=e[3]*i,e[4]+=e[4]*i,e[5]+=e[5]*i,e}applyToBoundingSphere(e){const r=ve(xe(e)),i=this.offset/r;return Ge(xe(this.sphere),xe(e),xe(e),i),this.sphere[3]=e[3]+e[3]*this.offset/r,this.sphere}};const Br=new da;function ua(t){return t!=null?(Br.offset=t,Br):null}new ca;const bi=N(),ha=N();let ma=class{constructor(e){this._bits=[...e]}equals(e){return si(this._bits,e.bits)}get code(){return this._code??(this._code=String.fromCharCode(...this._bits)),this._code}get bits(){return this._bits}},fa=class extends Qe{constructor(){var e;super(),this._parameterBits=((e=this._parameterBits)==null?void 0:e.map(()=>0))??[],this._parameterNames??(this._parameterNames=[])}get key(){return this._key??(this._key=new ma(this._parameterBits)),this._key}decode(e=this.key){const r=this._parameterBits;this._parameterBits=[...e.bits];const i=this._parameterNames.map(o=>`    ${o}: ${this[o]}`).join(`
...
return mix(color, vec4(HIGHLIGHT_COLOR.rgb, color.a), highlightFactor * HIGHLIGHT_COLOR.a);
      ...
      `:s`#define highlightSlice(_color_, _pos_) (_color_)`;e.hasSliceInVertexProgram&&t.vertex.uniforms.add(...r).code.add(i),t.fragment.uniforms.add(...r).code.add(i),t.fragment.code.add(a)}function $i(t,e,r){return t.instancedDoublePrecision?X(Qa,r.camera.viewInverseTransposeMatrix[3],r.camera.viewInverseTransposeMatrix[7],r.camera.viewInverseTransposeMatrix[11]):e.slicePlaneLocalOrigin}function Li(t,e){return t!=null?nt(Nt,e.origin,t):e.origin}function Pi(t,e,r){return t.hasSliceTranslatedView?e!=null?Qt(en,r.camera.viewMatrix,e):r.camera.viewMatrix:null}function Ja(t,e,r){if(r.slicePlane==null)return Je;const i=$i(t,e,r),o=Li(i,r.slicePlane),a=Pi(t,i,r);return a!=null?ht(Nt,o,a):o}function kr(t,e,r,i){if(i==null||r.slicePlane==null)return Je;const o=$i(t,e,r),a=Li(o,r.slicePlane),n=Pi(t,o,r);return n!=null?(Fo(tt,i,a),ht(Nt,a,n),ht(tt,tt,n),nt(tt,tt,Nt)):i}const Qa=N(),Nt=N(),tt=N(),en=fr();function tn(t,e){if(e.output!==D.ObjectAndLayerIdColor)return t.vertex.code.add(s`void forwardObjectAndLayerIdColor() {}`),void t.fragment.code.add(s`void outputObjectAndLayerIdColor() {}`);const r=e.objectAndLayerIdColorInstanced;t.varyings.add("objectAndLayerIdColorVarying","vec4"),t.attributes.add(r?p.INSTANCEOBJECTANDLAYERIDCOLOR:p.OBJECTANDLAYERIDCOLOR,"vec4"),t.vertex.code.add(s`
...
return proj * (view * vec4(pos, 1.0));
    ...
    `),e.output===D.Normal&&(Na(o),o.code.add(s`
...
forwardTextureCoordinates();`),t.include(We,e),i.main.add(s`
          ...
          ${R(o,s`vec4 texColor = texture(tex, ${l?"colorUV":"vuv0"});
                 discardOrAdjustAlpha(texColor);`)}`);break;case D.Shadow:case D.ShadowHighlight:case D.ShadowExcludeHighlight:case D.ViewshedShadow:case D.ObjectAndLayerIdColor:He(r,e),t.include(je,e),t.include($e,e),t.include(ct,e),t.include(kn,e),t.include(Ue,e),t.include(tn,e),qi(t),t.varyings.add("depth","float"),o&&i.uniforms.add(new Z("tex",c=>c.texture)),r.main.add(s`vpos = getVertexInLocalOriginSpace();
vpos = subtractOrigin(vpos);
vpos = addVerticalOffset(vpos, localOrigin);
...
forwardObjectAndLayerIdColor();`),t.include(We,e),i.main.add(s`
          ...
          ${a===D.ObjectAndLayerIdColor?s`outputObjectAndLayerIdColor();`:s`outputDepth(depth);`}`);break;case D.Normal:{He(r,e),t.include(je,e),t.include(Bt,e),t.include(Wi,e),t.include($e,e),t.include(ct,e),o&&i.uniforms.add(new Z("tex",u=>u.texture)),n===Q.ScreenDerivative&&t.varyings.add("vPositionView","vec3");const c=n===Q.Attribute||n===Q.Compressed;r.main.add(s`
          ...
          fragColor = vec4(0.5 + 0.5 * normal, 1.0);`);break}case D.Highlight:He(r,e),t.include(je,e),t.include($e,e),t.include(ct,e),o&&i.uniforms.add(new Z("tex",c=>c.texture)),r.main.add(s`vpos = getVertexInLocalOriginSpace();
vpos = subtractOrigin(vpos);
vpos = addVerticalOffset(vpos, localOrigin);
gl_Position = transformPosition(proj, view, vpos);
...
}`)}function to(t){const e=3.141592653589793,r=.3183098861837907;t.vertex.constants.add("PI","float",e),t.fragment.constants.add("PI","float",e),t.fragment.constants.add("LIGHT_NORMALIZATION","float",r),t.fragment.constants.add("INV_PI","float",r),t.fragment.constants.add("HALF_PI","float",1.570796326794897),t.fragment.constants.add("TWO_PI","float",6.28318530717958)}function Er(t,e){const r=t.fragment.code;t.include(to),e.pbrMode!==$.Normal&&e.pbrMode!==$.Schematic&&e.pbrMode!==$.Simplified&&e.pbrMode!==$.TerrainWithWater||(r.add(s`float normalDistribution(float NdotH, float roughness)
{
...
return outColor;
}`))}const fs=.4;function Sr(t){t.constants.add("ambientBoostFactor","float",fs)}function Cr(t){t.uniforms.add(new ie("lightingGlobalFactor",(e,r)=>r.lighting.globalFactor))}function ro(t,e){const r=t.fragment;switch(t.include(br,e),e.pbrMode!==$.Disabled&&t.include(Er,e),t.include(us,e),t.include(to),r.code.add(s`
