const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RealisticTree.glsl-DsOpQNoe.js","assets/index-DV3MVxlX.js","assets/index-D3OSfFaz.css","assets/QueryEngine-B6njQHXI.js","assets/featureConversionUtils-Ccy5OHdM.js","assets/WhereClause-B9wncO2y.js","assets/TimeOnly-Coo2Hmbh.js","assets/timeSupport-7xrnqvtZ.js","assets/QueryEngineCapabilities-DjYb9CEb.js","assets/Scheduler-BcTpNdcd.js","assets/signal-DkzpTIF_.js","assets/ReactiveMap-ngQ2Sr_d.js","assets/PooledRBush-DXWHVWWh.js","assets/quickselect-QQC62dOK.js","assets/ViewingMode-dBUh39ak.js","assets/Indices-BUOt1ZR_.js","assets/glUtil-CFv2RXTA.js","assets/enums-Dk3osxpS.js","assets/VertexElementDescriptor-BOD-G50G.js","assets/NormalAttribute.glsl-BUCAYx2r.js","assets/interfaces-DDtDqZYj.js","assets/VertexAttribute-BdZWZuT1.js","assets/basicInterfaces-CZwQPxTp.js","assets/NestedMap-GuqgquCN.js","assets/mat4f64-CSKppSlJ.js","assets/Util-CrvtY-DV.js","assets/vec32-ClB-VmTs.js","assets/InterleavedLayout-C8e_TP-B.js","assets/BufferView-MtSf1gV8.js","assets/types-D0PSWh4d.js","assets/Octree-B8pQy9Mx.js","assets/sphere-Bw8msQey.js","assets/mat3-C-7dTlBf.js","assets/mat3f64-q3fE-ZOt.js","assets/plane-C3nyLCT2.js","assets/quatf64-aQ5IuZRd.js","assets/IntersectorInterfaces-dI_rFEZm.js","assets/BufferObject-DY2hHfLd.js","assets/Texture-A69hX9_c.js","assets/boundedPlane-_OjqHtu2.js","assets/lineSegment-ChputGwF.js","assets/VertexArrayObject-BVlfW17b.js","assets/doublePrecisionUtils-B0owpBza.js","assets/floatRGBA-BYPs0TDL.js","assets/AlphaCutoff-UcccL64p.js","assets/renderState-BqKKaxGi.js","assets/projectVectorToVector-BJ1xMHiN.js","assets/projectPointToVector-C-SKG8e6.js","assets/computeTranslationToOriginAndRotation-DIRyJzDZ.js","assets/MeshLocalVertexSpace-C_G94sWN.js","assets/vec3f32-nZdmKIgz.js","assets/orientedBoundingBox-DxUhzSwk.js","assets/quat-ZLUQwtmE.js","assets/spatialReferenceEllipsoidUtils-C5NCQv-C.js","assets/triangle-De56afHp.js","assets/BindType-BmZEZMMh.js"])))=>i.map(i=>d[i]);
import{aQ as $,bz as si,I as Te,s as li,c8 as ci,c_ as Rt,j as m,m as z,k as ur,ar as di,as as ui,dv as go,lA as xo,aU as hr,hf as Je,jW as Qt,bC as oe,hj as Dt,T as To,i2 as ye,aD as _o,hd as bo,bM as It,nD as hi,nE as mi,gd as Le,gf as Ft,hc as zt,bO as fi,bN as Eo,cw as So,cK as Co,hl as ut,b$ as Ao,nF as wo,nG as Mo,jk as yo,_ as Tt,dt as St,hn as Oo,fh as Ro,c0 as Io,eL as Ir,j9 as $o,cv as rt,fY as it,w as $r,nH as No,az as Lo,aC as Po,ay as Do}from"./index-DV3MVxlX.js";import{r as ve,o as X,q as Ge,E as ht,u as Fo,c as nt,I as Nr,v as zo,H as pi,R as ke,s as Ot,_ as vi,A as mr,g as Lr,P as Bo,N as Go}from"./vec32-ClB-VmTs.js";import{s as U}from"./Util-CrvtY-DV.js";import{l as er}from"./ViewingMode-dBUh39ak.js";import{H as Vo}from"./InterleavedLayout-C8e_TP-B.js";import{n as D,S as gi,u as mt,b as fe,a as Q,t as Bt,c as Pr,o as kt,r as Ho}from"./NormalAttribute.glsl-BUCAYx2r.js";import{t as Qe,o as s,r as R}from"./interfaces-DDtDqZYj.js";import{e as p}from"./VertexAttribute-BdZWZuT1.js";import{a as I}from"./BindType-BmZEZMMh.js";import{a as tr,O as rr,s as be,i as ge,e as _t,n as Gt,u as Ve}from"./basicInterfaces-CZwQPxTp.js";import{o as _e}from"./AlphaCutoff-UcccL64p.js";import"./boundedPlane-_OjqHtu2.js";import{E as xi,U as xe}from"./sphere-Bw8msQey.js";import{E as Uo,R as Ct,O as de,X as Oe,I as ae,D as ft,G as Ie,t as jo,_ as Wo,f as qo,c as pe,L as Ze}from"./enums-Dk3osxpS.js";import{B as Vt,o as ko,g as Ht,r as Yo,c as Xo,p as Zo,f as Ko}from"./renderState-BqKKaxGi.js";import{j as Jo}from"./mat3-C-7dTlBf.js";import{e as bt,o as et}from"./mat3f64-q3fE-ZOt.js";import{e as fr,o as Dr}from"./mat4f64-CSKppSlJ.js";import{I as Qo,L as ea}from"./orientedBoundingBox-DxUhzSwk.js";import{x as Ti,c as Fr,y as ta,u as ra,q as ia,i as zr}from"./BufferView-MtSf1gV8.js";import{b as oa,p as _i,m as Ye,a as aa}from"./Texture-A69hX9_c.js";import{o as na,r as sa}from"./doublePrecisionUtils-B0owpBza.js";import{t as la}from"./requestImageUtils-CZc1lwBN.js";let ca=class{constructor(e=0){this.componentLocalOriginLength=0,this._totalOffset=0,this._offset=0,this._tmpVertex=$(),this._tmpMbs=xi(),this._tmpObb=new Qo,this._resetOffset(e)}_resetOffset(e){this._offset=e,this._totalOffset=e}set offset(e){this._resetOffset(e)}get offset(){return this._offset}set componentOffset(e){this._totalOffset=this._offset+e}set localOrigin(e){this.componentLocalOriginLength=ve(e)}applyToVertex(e,r,i){const o=X(bi,e,r,i),a=X(ha,e,r,i+this.componentLocalOriginLength),n=this._totalOffset/ve(a);return Ge(this._tmpVertex,o,a,n),this._tmpVertex}applyToAabb(e){const r=this.componentLocalOriginLength,i=e[0],o=e[1],a=e[2]+r,n=e[3],l=e[4],c=e[5]+r,u=Math.abs(i),d=Math.abs(o),h=Math.abs(a),v=Math.abs(n),f=Math.abs(l),T=Math.abs(c),_=.5*(1+Math.sign(i*n))*Math.min(u,v),g=.5*(1+Math.sign(o*l))*Math.min(d,f),G=.5*(1+Math.sign(a*c))*Math.min(h,T),P=Math.max(u,v),F=Math.max(d,f),L=Math.max(h,T),B=Math.sqrt(_*_+g*g+G*G),M=Math.sign(u+i),S=Math.sign(d+o),E=Math.sign(h+a),y=Math.sign(v+n),O=Math.sign(f+l),x=Math.sign(T+c),C=this._totalOffset;if(B<C)return e[0]-=(1-M)*C,e[1]-=(1-S)*C,e[2]-=(1-E)*C,e[3]+=y*C,e[4]+=O*C,e[5]+=x*C,e;const w=C/Math.sqrt(P*P+F*F+L*L),V=C/B,j=V-w,q=-j;return e[0]+=i*(M*q+V),e[1]+=o*(S*q+V),e[2]+=a*(E*q+V),e[3]+=n*(y*j+w),e[4]+=l*(O*j+w),e[5]+=c*(x*j+w),e}applyToMbs(e){const r=ve(xe(e)),i=this._totalOffset/r;return Ge(xe(this._tmpMbs),xe(e),xe(e),i),this._tmpMbs[3]=e[3]+e[3]*this._totalOffset/r,this._tmpMbs}applyToObb(e){return ea(e,this._totalOffset,this._totalOffset,er.Global,this._tmpObb),this._tmpObb}},da=class{constructor(e=0){this.offset=e,this.sphere=xi(),this.tmpVertex=$()}applyToVertex(e,r,i){const o=this.objectTransform.transform,a=X(bi,e,r,i),n=ht(a,a,o),l=this.offset/ve(n);Ge(n,n,n,l);const c=this.objectTransform.inverse;return ht(this.tmpVertex,n,c),this.tmpVertex}applyToMinMax(e,r){const i=this.offset/ve(e);Ge(e,e,e,i);const o=this.offset/ve(r);Ge(r,r,r,o)}applyToAabb(e){const r=this.offset/Math.sqrt(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]+=e[0]*r,e[1]+=e[1]*r,e[2]+=e[2]*r;const i=this.offset/Math.sqrt(e[3]*e[3]+e[4]*e[4]+e[5]*e[5]);return e[3]+=e[3]*i,e[4]+=e[4]*i,e[5]+=e[5]*i,e}applyToBoundingSphere(e){const r=ve(xe(e)),i=this.offset/r;return Ge(xe(this.sphere),xe(e),xe(e),i),this.sphere[3]=e[3]+e[3]*this.offset/r,this.sphere}};const Br=new da;function ua(t){return t!=null?(Br.offset=t,Br):null}new ca;const bi=$(),ha=$();let ma=class{constructor(e){this._bits=[...e]}equals(e){return si(this._bits,e.bits)}get code(){return this._code??(this._code=String.fromCharCode(...this._bits)),this._code}get bits(){return this._bits}},fa=class extends Qe{constructor(){var e;super(),this._parameterBits=((e=this._parameterBits)==null?void 0:e.map(()=>0))??[],this._parameterNames??(this._parameterNames=[])}get key(){return this._key??(this._key=new ma(this._parameterBits)),this._key}decode(e=this.key){const r=this._parameterBits;this._parameterBits=[...e.bits];const i=this._parameterNames.map(o=>`    ${o}: ${this[o]}`).join(`
